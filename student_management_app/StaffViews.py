...
from student_management_app.models import Curricular, CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, Attendance, AttendanceReport, LeaveReportStaff, FeedBackStaffs, StudentResult
...
def curricular_activity(request):
    students = Curricular.objects.all()
    context = {
        "students": students
    }
    return render(request, 'staff_template/curricular_activity.html', context)
