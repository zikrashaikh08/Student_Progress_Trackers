...
urlpatterns = [
    ...
    path('curricular_activity/', StaffViews.curricular_activity, name="curricular_activity"),
    ...
    path('extra_curricular_activity/' , StudentViews.extra_curricular_activity, name="extra_curricular_activity"),
    path('extra_curricular_activity_save/' , StudentViews.extra_curricular_activity_save, name="extra_curricular_activity_save"),
]
